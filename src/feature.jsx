      ...
      <div className="md:grid md:grid-cols-1 gap-y-6 md:ml-10 flex flex-col items-center justify-around gap-x-6">
            ...
            >
              <img
                ...
                style={{ backgroundColor: "rgba(57, 131, 120, 1)" }}
              />
              <h3 className=" text-white text-center -mt-12 text-xl">
                Customer <br />
                management
              </h3>
            ...
            >
              <img
                ...
                style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}
              />
              <h3 className=" text-white -mt-12 text-center  text-xl">
                Scheduling
              </h3>
            ...
            >
              <img
                ...
                style={{ backgroundColor: "rgba(57, 131, 120, 1)" }}
              />
              <h3 className=" text-white -mt-12 text-center  gap-y-6 text-xl">
                Quotes and <br />
                estimatest
              </h3>
              <p className="text-white ml-2 leading-tight mt-6">
          ...
          <div className="grid-cols-2 gap-y-6 flex flex-col items-center justify-around gap-x-6">
            <div
              className="border-none rounded-xl h-auto w-72 px-2 py-4"
              style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}
            >
